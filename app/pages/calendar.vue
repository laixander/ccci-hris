  ...
  <div class="flex flex-col flex-1 overflow-y-auto scrollbar">
    ...
    <div>
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4">
        <UPageCard
          ...
          description="View upcoming company events and holidays."
          variant="naked"
          ...
          <div class="flex justify-end gap-2 flex-1 flex-wrap">
            <UFieldGroup>
              <UButton
                ...
                color="neutral"
                :variant="viewMode === 'month' ? 'subtle' : 'outline'"
              ...
              <UButton
                ...
                color="neutral"
                :variant="viewMode === 'day' ? 'subtle' : 'outline'"
                @click="viewMode = 'day'"
              />
            </UFieldGroup>
    ...
    <template v-else-if="viewMode === 'day'">
      <div class="flex items-center justify-between p-4">
        ...
        <p class="text-lg font-semibold text-toned">
          {{ WEEK_DAYS[new Date(year, month - 1, selectedDay).getDay()] }}, {{ months.find(m => m.value === month)?.label }} {{ selectedDay }}, {{ year }}
        </p>
      ...
      <div class="flex-1 flex flex-col bg-[var(--ui-bg)] p-4 sm:p-6">
        <div class="flex-1 border border-[var(--ui-border)] rounded-md p-4 relative flex flex-col bg-[var(--ui-bg)] shadow-sm">
